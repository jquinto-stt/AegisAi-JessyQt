...
export const NectoBanner: React.FC<NectoBannerProps> = ({
  ...
  return (
    <div className="relative rounded-3xl p-6 sm:p-8 overflow-hidden bg-white dark:bg-[#2C2D31] border border-slate-200 dark:border-[#374151] shadow-xs flex flex-wrap items-center justify-between gap-4">
      {/* Official Necto Logo Watermark & Repeating Mosaic */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden select-none">
        {/* Prominent Official Necto Logo on the right */}
        <div className="absolute -right-6 top-1/2 -translate-y-1/2 w-80 sm:w-96 opacity-[0.14] dark:opacity-[0.18] transform rotate-[-4deg]">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-x-12 gap-y-8 w-full h-full p-4 opacity-[0.07] dark:opacity-[0.11] transform -rotate-6 scale-110">
      ...
      {/* Action / Auxiliary Node if provided */}
      {actionNode && (
