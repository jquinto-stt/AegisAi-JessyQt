...
describe("administrador como rol normal (invariante C9)", () => {
  it("resuelve a `admin_tienda` y obtiene las 22 capacidades", async () => {
    ...
    expect(ctx.capacidades).toHaveLength(22);
    ...
    expect(rolesStore.porId("admin_tienda")?.capacidades).toHaveLength(22);
  });
