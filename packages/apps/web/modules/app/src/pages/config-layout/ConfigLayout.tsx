...
export function CardHead({ children }: { children: ReactNode }) {
  return (
    <h2 className="text-sm font-semibold text-gray-900 dark:text-white">{children}</h2>
  );
}
...
export function ConfigShell({
  ...
  return (
    ...
    >
      <div className="mb-4">
        <h2 className="text-lg font-semibold text-gray-800 dark:text-white/90">{titulo}</h2>
