...
const InstagramTikTokIcon = () => (
  <div className="flex items-center -space-x-1.5 shrink-0">
    {/* Instagram */}
    <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] shadow-xs">
    ...
    {/* TikTok */}
    <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-gray-950 text-white shadow-xs border border-white/20">
...
const GoogleIcon = () => (
  <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-white p-1.5 shadow-xs border border-gray-200 dark:border-gray-700 dark:bg-gray-800 shrink-0">
...
const ColegaIcon = () => (
  <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-amber-50 text-amber-600 border border-amber-200/70 dark:bg-amber-500/10 dark:text-amber-400 dark:border-amber-500/20 shrink-0">
    <Handshake className="h-4.5 w-4.5" />
  </div>
);

const ComunidadIcon = () => (
  <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-violet-50 text-violet-600 border border-violet-200/70 dark:bg-violet-500/10 dark:text-violet-400 dark:border-violet-500/20 shrink-0">
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-3.5 rounded-2xl border p-4 text-left font-medium transition-all duration-150 cursor-pointer ${
                      seleccionado
                        ? "border-brand-500 bg-brand-50/70 text-brand-900 shadow-xs ring-2 ring-brand-500/20 dark:border-brand-400 dark:bg-brand-500/15 dark:text-brand-100"
