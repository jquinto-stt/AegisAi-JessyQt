 ...
 * Se pinta en `public-500` porque es el color del contenido abierto, el mismo de
 * la banda de esta página.
 */
export const HelpSupportCta: React.FC = () => (
  <section aria-labelledby="help-support-cta" className="mt-16">
    <div className="flex flex-col gap-5 rounded-2xl border border-public-500/30 bg-public-500/[0.06] p-6 sm:flex-row sm:items-center sm:justify-between sm:p-8">
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0">
          <h2
            id="help-support-cta"
            className="text-lg font-bold text-secondary-600 dark:text-white"
          >
      ...
      <Link
        to="/soporte"
        className="inline-flex h-11 flex-none items-center justify-center rounded-full bg-public-500 px-6 text-theme-sm font-bold text-white transition-colors hover:bg-public-700"
      >
        Ir a soporte
      </Link>
    </div>
