...
export const Composer = observer(({ convId }: { convId: string }) => {
  ...
  return (
    <div className="sticky bottom-0 border-t border-gray-200 bg-white p-3 sm:p-4 dark:border-gray-800 dark:bg-transparent">
      <form
        onSubmit={(e) => {
          e.preventDefault();
          enviar();
      ...
      >
        ...
        <button
          ...
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-800 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-white"
        >
        ...
        <div className="relative min-w-0 flex-1">
          <input
            ...
            className="h-10 w-full rounded-xl border border-gray-200 bg-gray-50/70 px-4 text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-500 focus:bg-white focus:outline-hidden focus:ring-2 focus:ring-brand-500/15 disabled:cursor-not-allowed disabled:opacity-60 dark:border-gray-700 dark:bg-gray-800/60 dark:text-white/90 dark:placeholder:text-gray-500"
          />
        </div>
        ...
        >
          <svg className="h-5 w-5 stroke-current" viewBox="0 0 24 24" fill="none">
            ...
            <path d="M12 7.5L12 10.5" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M14.5 8.25L14.5 9.75" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M9.5 8.25L9.5 9.75" strokeWidth="1.5" strokeLinecap="round" />
          </svg>
        </button>
        ...
        <button
          ...
          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-brand-500 text-white shadow-2xs transition-all hover:bg-brand-600 disabled:cursor-not-allowed disabled:opacity-50"
        >
