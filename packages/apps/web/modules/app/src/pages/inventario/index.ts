...
// llaman `InicioPage` / `ExistenciasPage` / `MovimientosPage` / `AuditoriaPage`
// / `ConfigPage`, igual que en `pages/pedidos/`. `App.tsx` las aliasa al
// importarlas, que es como ya resuelve la colisión entre los dos `ConfigPage`.
