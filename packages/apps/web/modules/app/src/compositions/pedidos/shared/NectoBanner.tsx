...
export const NectoBanner: React.FC<NectoBannerProps> = ({
  ...
  return (
    <div className="relative rounded-3xl p-6 sm:p-7 overflow-hidden bg-white dark:bg-[#2C2D31] border border-slate-200 dark:border-[#374151] shadow-xs">
      {customBanner ? (
        /* Custom Business Banner Background with Gradient Overlay */
        <div className="absolute inset-0 pointer-events-none overflow-hidden select-none">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-white/95 via-white/85 to-white/40 dark:from-[#2C2D31]/95 dark:via-[#2C2D31]/85 dark:to-[#2C2D31]/40 backdrop-blur-[1px]" />
        </div>
      ) : (
        /* Default Official Necto Logo Watermark & Repeating Mosaic */
        <div className="absolute inset-0 pointer-events-none overflow-hidden select-none">
