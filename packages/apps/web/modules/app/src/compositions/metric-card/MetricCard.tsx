...
export function MetricCard({
  ...
  // Delta neutro: el verde/rojo saturado en un badge de variación es ruido
  // cuando hay 5 KPIs seguidos. La DIRECCIÓN la da la flecha y el signo; el
  // color se reserva para la acción primaria y los mensajes salientes.
  const badgeColor: BadgeColor = "light";
