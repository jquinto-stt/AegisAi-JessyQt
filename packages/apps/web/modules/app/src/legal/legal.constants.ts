  ...
  sections: [
    {
      ...
      blocks: [
        {
          kind: "p",
          text: "Necto es una plataforma para operar un negocio: te permite dar de alta tu tienda y sus sucursales, llevar inventario, registrar pedidos, agendar citas y atender a tus clientes por tus propios canales, incluido WhatsApp.",
        },
        {
          kind: "p",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          kind: "p",
          text: "Una cuenta puede administrar varias tiendas y una tienda puede tener varias sucursales. Cada persona que acceda debe hacerlo con su propia credencial: no compartas el acceso.",
        },
        {
          kind: "p",
        ...
        { kind: "p", text: "Para darte el servicio tratamos:" },
        {
          ...
          items: [
            ...
            },
            {
              ...
              description:
                "Nombre de la tienda y de cada sucursal, tipo de negocio, país, moneda, dirección, horarios y teléfono de atención.",
            },
            {
